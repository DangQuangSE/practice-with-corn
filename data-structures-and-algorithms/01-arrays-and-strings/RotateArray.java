 ...
 *
 * Lưu ý: hàm sửa mảng tại chỗ (in-place), không trả về gì — giống đề gốc trên LeetCode.
 * k có thể lớn hơn độ dài mảng, nhớ xử lý phần dư.
 * Mục tiêu: O(n) thời gian, O(1) bộ nhớ phụ (đảo ngược toàn mảng rồi đảo từng nửa).
 */
